...
def single_number(arr):
    ...
    # how de we get rid of one of the for loops?
    # when looping through elements, let's
    # count how many times they occur
    # can we use list.count(number) and check if the 
    # count == 1
    ...
    for x in arr:
        # loop through every element in the list
        if arr.count(x) == 1:
            # do a comparison to see if the two elements
            # ever match
            return x
